...
latex_documents = [(master_doc, 'edgyproject.tex', 'edgy.project Documentation', 'Romain Dorgueil', 'manual'), ]
...
texinfo_documents = [(master_doc, 'edgyproject', 'edgy.project Documentation', author, 'edgyproject',
